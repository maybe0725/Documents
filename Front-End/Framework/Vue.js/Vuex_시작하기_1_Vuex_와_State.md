...
state 에 정의된 `counter` 속성은 Parent 컴포넌트 에서 사용하던 data 속성 `counter` 와 동일한 역할을 한다. 
...
![vuex-data-management](https://joshua1988.github.io/images/posts/web/vuejs/vuex-1/vuex-data-management.png)
